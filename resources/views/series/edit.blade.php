...
@section('title', 'Edit Series - Film Showlist App')
        ...
        <form action="{{ route('series.update', $series->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                       id="judul" name="judul" value="{{ old('judul', $series->judul) }}" required>
                @error('judul')
            ...
            <div class="mb-3">
                ...
                <div style="border: 1px solid #ccc; padding: 10px; border-radius: 4px; background: #f9f9f9;">
                    ...
                    @else
                        @php
                            $selectedGenres = old('genre_ids', $series->genres->pluck('id')->toArray());
                        @endphp
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('jumlah_episode') is-invalid @enderror"
                       id="jumlah_episode" name="jumlah_episode" value="{{ old('jumlah_episode', $series->jumlah_episode) }}" min="1" required>
